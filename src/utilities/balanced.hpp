...
namespace e_regex
{
    ...
    template<unsigned round_par, unsigned square_par, unsigned braces, typename head, typename... strings>
    struct balanced<round_par, square_par, braces, head, strings...>
        : public balanced<round_par, square_par, braces, strings...>
    {
    };

    template<unsigned round_par, unsigned square_par, unsigned braces>

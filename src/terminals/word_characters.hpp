#ifndef E_REGEX_NODES_TERMINALS_WORD_CHARACTERS_HPP_
#define E_REGEX_NODES_TERMINALS_WORD_CHARACTERS_HPP_
...
#endif /* E_REGEX_NODES_TERMINALS_WORD_CHARACTERS_HPP_*/
